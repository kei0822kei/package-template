"""
Calculations provided by package_template.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'package_template'
        ...
        spec.output('package_template', valid_type=SinglefileData, help='diff between file1 and file2.')
